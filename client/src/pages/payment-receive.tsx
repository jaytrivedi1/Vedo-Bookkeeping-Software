...
export default function PaymentReceive() {
  ...
  const { data: customerInvoices, isLoading: isInvoicesLoading } = useQuery({
    ...
    queryFn: () => {
      ...
      return apiRequest(`/api/transactions?type=invoice&contactId=${watchContactId}&status=pending,overdue`);
    },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="w-full bg-muted/50 p-0">
            <TabsTrigger value="details" className="flex-1 rounded-none data-[state=active]:bg-background">
              Payment Details
            </TabsTrigger>
            <TabsTrigger 
              value="apply" 
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <TabsContent value="apply" className="mt-4 p-0">
                {watchContactId && (
                  <Card>
